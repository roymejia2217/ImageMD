...
class DateExtractor:
    def __init__(self):
        ...
        self.patterns = [
            ...
            (re.compile(r'(?:^|[\s_.-])(20\d{2})_(\d{2})_(\d{2})_(\d{2})_(\d{2})_(\d{2})', re.IGNORECASE), '%Y_%m_%d_%H_%M_%S', True),
            ...
            (re.compile(r'(?:^|\D)(20\d{2})(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})', re.IGNORECASE), '%Y%m%d%H%M%S', True),
            ...
            (re.compile(r'(?:^|\D)(20\d{2})(\d{2})(\d{2})(\d{2})(\d{2})(?:\D|$)', re.IGNORECASE), '%Y%m%d%H%M', True),
            ...
            (re.compile(r'Screenshot[-_]?(20\d{2})(\d{2})(\d{2})[-_]?(\d{2})(\d{2})(\d{2})', re.IGNORECASE), '%Y%m%d%H%M%S', True),
            ...
            (re.compile(r'(?:^|[\s_-])(20\d{2})[-_.](\d{2})[-_.](\d{2})[\s_-]+(\d{2})(\d{2})(\d{2})(?:\d+)?(?:[._-]|$)', re.IGNORECASE), '%Y-%m-%d %H%M%S', True),

            # 7. WhatsApp estándar IMG-YYYYMMDD-WAXXXX (Sin hora)
            # Coincidencia: IMG-20230101-WA0001
            (re.compile(r'(?:IMG|VID)[-_]?(20\d{2})(\d{2})(\d{2})[-_]WA', re.IGNORECASE), '%Y%m%d', False),

            # 4. PXL (Google Pixel) con hora
            # Coincidencia: PXL_20230101_120000...
            (re.compile(r'PXL[-_]?(20\d{2})(\d{2})(\d{2})[-_]?(\d{2})(\d{2})(\d{2})', re.IGNORECASE), '%Y%m%d%H%M%S', True),
            ...
            (re.compile(r'(?:^|[-_])(20\d{2})(\d{2})(\d{2})[-_]?(\d{2})(\d{2})(\d{2})(?:[._-]|$)', re.IGNORECASE), '%Y%m%d%H%M%S', True),

            # 6. Genérico YYYY-MM-DD HH.MM.SS
            # Coincidencia: 2023-01-01 12.00.00.jpg
            (re.compile(r'(20\d{2})[-_](\d{2})[-_](\d{2})[\s_-]+(\d{2})[\.:](\d{2})[\.:](\d{2})'), '%Y-%m-%d %H.%M.%S', True),

            # 7. Respaldo: Solo Fecha YYYYMMDD (Sin hora)
            # Coincidencia: 20230101_...
            (re.compile(r'(?:^|[-_])(20\d{2})(\d{2})(\d{2})(?:[._-]|$)', re.IGNORECASE), '%Y%m%d', False),
        ]
            ...
            if match:
                try:
                    if date_fmt == 'UNIX_MS':
                        ...
                        # Conversión UTC explícita.
                        # Usando fromtimestamp con UTC luego haciéndolo ingenuo (naive) para mantener consistencia.
